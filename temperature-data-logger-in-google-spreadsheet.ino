...
const char* ssid = "raki";                //replace with our wifi ssid
const char* password = "123456789";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = "#include <ESP8266WiFi.h>
#include "HTTPSRedirect.h"
#include "DebugMacros.h"
#include <DHT.h>
...
const char* host = "script.google.com";
const char *GScriptId = "AKfycbwy1DUQi9zNTgoN5Q3rXZL7ofLZGjcoTIiBHbEkcTM2cqHzzW4-EAkTuiEk1DAFdKCy8w"; // Replace with your own google script id
...
}"; // Replace with your own google script id
const int httpsPort = 443; //the https port is same
